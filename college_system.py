...
db = mysql.connect(host="localhost",port=3307,user="root",password="",database="college")
...
def student_session(username):
    while 1:
        ...
        if user_option == "1":
            ...
            records = command_handler.fetchall()
            for record in records:
                with open("C:/Users/Punit/Desktop/Register.txt", "w") as f:
                    f.write(str(records)+"\n")
                f.close()
...
def admin_session():
    while 1:
        ...
        if user_option == "1":
            ...
            db.commit()
            print(username + " has been registerd as a student")
            ...
            db.commit()
            print(username + " has been registerd as a teacher")
